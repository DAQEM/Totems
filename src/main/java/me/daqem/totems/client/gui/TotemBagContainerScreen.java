...
public class TotemBagContainerScreen extends ContainerScreen<TotemBagContainer> {
    ...
    protected void drawGuiContainerForegroundLayer(MatrixStack matrixStack, int x, int y) {
        ...
        this.font.drawString(matrixStack, playerInventory.getDisplayName().getString(), 8, 38, 4210752);
    }
    ...
    protected void drawGuiContainerBackgroundLayer(MatrixStack matrixStack, float partialTicks, int x, int y) {
        ...
        blit(matrixStack, posX, posY, 0, 0, this.xSize, 18 + 17);
        blit(matrixStack, posX, posY + 18 + 17, 0, 126, this.xSize, 96);
    }
}
